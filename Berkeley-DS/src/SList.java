...
public void insertEnd(Object obj) {
  ...
  public static void main (String[] args) {
    ...
    new_list.insertEnd(6);
    new_list.insertEnd(9);
    new_list.insertEnd(12);
    new_list.insertEnd(15);
    new_list.insertFront(3);
    System.out.println("This is the new list:"+new_list.toString());
    testAfterInsertEnd();
  }
